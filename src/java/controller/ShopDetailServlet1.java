 ...
 */
@WebServlet(name="ShopDetailServlet1", urlPatterns={"/shopDetail1"})
public class ShopDetailServlet1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShopDetailServlet1</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShopDetailServlet1 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if (cid_raw != null) {
            ...
            products = pd.getProductByCateId(cid);
            if (cid == 0) {
                cate[0] = true;
            }
        }
