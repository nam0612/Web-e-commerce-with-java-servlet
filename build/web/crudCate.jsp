<%-- 
    Document   : crudCate
    Created on : Nov 2, 2022, 10:34:29 AM
                        ...
                        <tbody>
                            <c:forEach var="cate" items="${requestScope.categories}">
                                ...
                                <tr>
                                    ...
                                    <td>${cate.name}</td>
                                    <td>
                                        <img src="${cate.image}" alt="alt" width="100px" height="100px"/>
                                    </td>
                                    <td>
                                        <a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="#" onclick="doDelete('${cate.id}')" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
